...
export type Hire = Versioned & { status: string; requestedBy: { kind: string; id: string }; proposal: { role: string; mission: string; teamId: string }; manifest: Manifest | null; manifestVersion: number | null; agentId: string };
